...
# Prisma 7+: pass URL via DATABASE_URL env; --url flag removed
export DATABASE_URL="$DIRECT_URL"

PRISMA_CONFIG="./packages/shared/prisma.config.ts"
PRISMA_SCHEMA="./packages/shared/prisma/schema.prisma"
