...
### Docker недоступен
В текущей среде выполнения Docker недоступен, поэтому пересборка Docker-образов не может быть выполнена автоматически. 

**Рекомендация:** Выполните пересборку образов в среде с доступом к Docker:
